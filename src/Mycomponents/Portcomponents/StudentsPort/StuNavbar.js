        ...
        <div>
            <div className="navbar fixed-top" style={{ ...navbar_styles }}>
                ...
                <div className="nav-props" style={{ paddingBottom: '1rem', width: '85%' }}>
                    <Link style={nav_props_styles} to='/materials'>Home</Link>
                    <Link style={nav_props_styles} to='/students'>Students</Link>
                    <Link style={nav_props_styles} to='/assignments'>Assignments</Link>
                    <Link style={nav_props_styles} to='/aboutus'>About us</Link>
