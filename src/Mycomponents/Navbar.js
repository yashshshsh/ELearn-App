...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar fixed-top" style={{ ...navbar_styles }}>
                <div className="nav-heading" style={{ fontWeight: 'bold', fontSize: '2.3rem' }}>
                    <p>LearnHuB</p>
                </div>
                <div className="nav-props" style={{ paddingBottom: '1rem', width: '85%' }}>
                    <Link style={nav_props_styles} to='/Tmaterials'>Materials</Link>
                    <Link style={nav_props_styles} to='/Tstudents'>Students</Link>
                    <Link style={nav_props_styles} to='/Tassignments'>Assignments</Link>
                    <Link style={nav_props_styles} to='/Taboutus'>About us</Link>
